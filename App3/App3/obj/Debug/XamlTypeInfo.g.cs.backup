...
namespace App3.App3_XamlTypeInfo
{
    ...
    internal partial class XamlTypeInfoProvider
    {
        ...
        private object Activate_0_LayoutAwarePage() { return new App3.Common.LayoutAwarePage(); }

        private object Activate_1_GroupedItemsPage() { return new App3.GroupedItemsPage(); }

        private object Activate_2_GroupDetailPage() { return new App3.GroupDetailPage(); }

        private object Activate_3_RichTextColumns() { return new App3.Common.RichTextColumns(); }

        private object Activate_4_ItemDetailPage() { return new App3.ItemDetailPage(); }
        ...
        private IXamlType CreateXamlType(string typeName)
        {
            ...
            case "App3.Common.LayoutAwarePage":
                userType = new XamlUserType(this, typeName, typeof(App3.Common.LayoutAwarePage), GetXamlTypeByName("Windows.UI.Xaml.Controls.Page"));
                userType.Activator = Activate_0_LayoutAwarePage;
                xamlType = userType;
                break;

            case "App3.GroupedItemsPage":
                userType = new XamlUserType(this, typeName, typeof(App3.GroupedItemsPage), GetXamlTypeByName("App3.Common.LayoutAwarePage"));
                userType.Activator = Activate_1_GroupedItemsPage;
                xamlType = userType;
                break;

            case "App3.GroupDetailPage":
                userType = new XamlUserType(this, typeName, typeof(App3.GroupDetailPage), GetXamlTypeByName("App3.Common.LayoutAwarePage"));
                userType.Activator = Activate_2_GroupDetailPage;
                xamlType = userType;
                break;

            case "App3.Common.RichTextColumns":
                userType = new XamlUserType(this, typeName, typeof(App3.Common.RichTextColumns), GetXamlTypeByName("Windows.UI.Xaml.Controls.Panel"));
                userType.Activator = Activate_3_RichTextColumns;
                userType.SetContentPropertyName("App3.Common.RichTextColumns.RichTextContent");
                userType.AddMemberName("RichTextContent");
                userType.AddMemberName("ColumnTemplate");
                xamlType = userType;
                break;

            case "App3.ItemDetailPage":
                userType = new XamlUserType(this, typeName, typeof(App3.ItemDetailPage), GetXamlTypeByName("App3.Common.LayoutAwarePage"));
        ...
        {
            var that = (App3.Common.RichTextColumns)instance;
        ...
        private IXamlMember CreateXamlMember(string longMemberName)
        {
            ...
            {
            case "App3.Common.RichTextColumns.RichTextContent":
                userType = (XamlUserType)GetXamlTypeByName("App3.Common.RichTextColumns");
                ...
                break;
            case "App3.Common.RichTextColumns.ColumnTemplate":
                userType = (XamlUserType)GetXamlTypeByName("App3.Common.RichTextColumns");
