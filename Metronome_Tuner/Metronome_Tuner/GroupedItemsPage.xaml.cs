...
namespace Metronome_Tuner
{
    ...
    /// </summary>
    public sealed partial class GroupedItemsPage : Metronome_Tuner.Common.LayoutAwarePage
    {
        ...
        void Header_Click(object sender, RoutedEventArgs e)
        {
            ...
            // 전달하여 새 페이지를 구성합니다.
            this.Frame.Navigate(typeof(GroupDetailPage), ((MenuDataGroup)group).UniqueId);
        }
