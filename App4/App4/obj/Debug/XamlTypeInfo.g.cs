...
namespace App4.App4_XamlTypeInfo
{
    ...
    internal partial class XamlTypeInfoProvider
    {
        ...
        private object Activate_0_LayoutAwarePage() { return new App4.Common.LayoutAwarePage(); }

        private object Activate_1_GroupedItemsPage() { return new App4.GroupedItemsPage(); }

        private object Activate_2_GroupDetailPage() { return new App4.GroupDetailPage(); }

        private object Activate_3_RichTextColumns() { return new App4.Common.RichTextColumns(); }

        private object Activate_4_ItemDetailPage() { return new App4.ItemDetailPage(); }
        ...
        private IXamlType CreateXamlType(string typeName)
        {
            ...
            case "App4.Common.LayoutAwarePage":
                userType = new XamlUserType(this, typeName, typeof(App4.Common.LayoutAwarePage), GetXamlTypeByName("Windows.UI.Xaml.Controls.Page"));
                userType.Activator = Activate_0_LayoutAwarePage;
                xamlType = userType;
                break;

            case "App4.GroupedItemsPage":
                userType = new XamlUserType(this, typeName, typeof(App4.GroupedItemsPage), GetXamlTypeByName("App4.Common.LayoutAwarePage"));
                userType.Activator = Activate_1_GroupedItemsPage;
                xamlType = userType;
                break;

            case "App4.GroupDetailPage":
                userType = new XamlUserType(this, typeName, typeof(App4.GroupDetailPage), GetXamlTypeByName("App4.Common.LayoutAwarePage"));
                userType.Activator = Activate_2_GroupDetailPage;
                xamlType = userType;
                break;

            case "App4.Common.RichTextColumns":
                userType = new XamlUserType(this, typeName, typeof(App4.Common.RichTextColumns), GetXamlTypeByName("Windows.UI.Xaml.Controls.Panel"));
                userType.Activator = Activate_3_RichTextColumns;
                userType.SetContentPropertyName("App4.Common.RichTextColumns.RichTextContent");
                userType.AddMemberName("RichTextContent");
                userType.AddMemberName("ColumnTemplate");
                xamlType = userType;
                break;

            case "App4.ItemDetailPage":
                userType = new XamlUserType(this, typeName, typeof(App4.ItemDetailPage), GetXamlTypeByName("App4.Common.LayoutAwarePage"));
        ...
        {
            var that = (App4.Common.RichTextColumns)instance;
        ...
        private IXamlMember CreateXamlMember(string longMemberName)
        {
            ...
            {
            case "App4.Common.RichTextColumns.RichTextContent":
                userType = (XamlUserType)GetXamlTypeByName("App4.Common.RichTextColumns");
                ...
                break;
            case "App4.Common.RichTextColumns.ColumnTemplate":
                userType = (XamlUserType)GetXamlTypeByName("App4.Common.RichTextColumns");
